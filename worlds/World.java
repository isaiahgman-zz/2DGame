...
public class World {
	...
	public World(Handler handler, String path) {
		...
		for(int i = 0; i < 100; i++) {
			entityManager.addEntity(new Rock(handler, (float)(Math.random() * 2400 + 64), 
					(float)(Math.random() * 3610 + 64)));
		}
		for(int i = 0; i < 300; i++) {
			entityManager.addEntity(new Tree(handler, (float)(Math.random() * 2400 + 64), 
					(float)(Math.random() * 3610 + 64)));
		}
